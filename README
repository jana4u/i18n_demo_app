...
* cd i18n_demo_app
* Run the migrations with <tt>rake db:migrate</tt> for ActiveRecordHelper
* <tt>./script/server</tt>
* Fire up your browser and go to <tt>localhost:3000</tt> – the index page should be loaded automatically.
...
Karel Minařík - http://www.karmi.cz - Czech locale
